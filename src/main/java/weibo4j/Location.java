...
public class Location extends Weibo {
	...
	public List<Geos> ipToGeo(String ip) throws WeiboException {
		return Geos.constructGeos(client.get(weibo4j.util.WeiboConfig.getValue("baseURL")
	...
	public List<Poisition> searchPoisByLocationByQ(String q)
			throws WeiboException {
		return Poisition
				.constructPois(client.get(weibo4j.util.WeiboConfig.getValue("baseURL")
	...
	public Poisition addPois(String srcid, String name, String address,
			...
			throws WeiboException {
		return new Poisition(client.post(weibo4j.util.WeiboConfig.getValue("baseURL")
