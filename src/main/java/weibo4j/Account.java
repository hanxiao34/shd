...
public class Account extends Weibo {
	...
	public JSONObject getUid() throws WeiboException {
		return client.get(
				weibo4j.util.WeiboConfig.getValue("baseURL") + "account/get_uid.json",
	...
	public Privacy getAccountPrivacy() throws WeiboException {
		return new Privacy(client.get(weibo4j.util.WeiboConfig.getValue("baseURL")
	...
	public List<School> getAccountProfileSchoolList(Map<String, String> map)
		...
		return School
				.constructSchool(client.get(weibo4j.util.WeiboConfig.getValue("baseURL")
	...
	public RateLimitStatus getAccountRateLimitStatus() throws WeiboException {
		return new RateLimitStatus(client.get(weibo4j.util.WeiboConfig.getValue("baseURL")
	...
	public User endSession() throws WeiboException {
		return new User(client.get(weibo4j.util.WeiboConfig.getValue("baseURL")
