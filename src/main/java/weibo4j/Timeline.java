...
public class Timeline extends Weibo {
	...
	public UserTimelineIds getUserTimelineIdsByUid(String uid)
			throws WeiboException {
		return new UserTimelineIds(client.get(weibo4j.util.WeiboConfig.getValue("baseURL")
	...
	public RepostTimelineIds getRepostTimelineIds(String id)
			throws WeiboException {
		return new RepostTimelineIds(client.get(weibo4j.util.WeiboConfig.getValue("baseURL")
	...
	public StatusWapper getRepostByMe() throws WeiboException {
		return Status.constructWapperStatus(client.get(
				weibo4j.util.WeiboConfig.getValue("baseURL") + "statuses/repost_by_me.json",
				access_token));
	}
	...
	public StatusWapper getMentions(Map<String, String> map)
		...
		PostParameter[] parList = ArrayUtils.mapToArray(map);
		return Status.constructWapperStatus(client.get(
				weibo4j.util.WeiboConfig.getValue("baseURL") + "statuses/mentions.json", parList,
				access_token));
	}
	...
	public MentionsIds getMentionsIds() throws WeiboException {
		return new MentionsIds(client.get(weibo4j.util.WeiboConfig.getValue("baseURL")
	...
	public JSONObject queryMid(Integer type, String id) throws WeiboException {
		return client.get(
				weibo4j.util.WeiboConfig.getValue("baseURL") + "statuses/querymid.json",
				new PostParameter[] { new PostParameter("id", id),
	...
	public JSONObject queryMid(Integer type, String id, int is_batch)
			throws WeiboException {
		return client
				.get(weibo4j.util.WeiboConfig.getValue("baseURL") + "statuses/querymid.json",
						new PostParameter[] { new PostParameter("id", id),
								new PostParameter("type", type.toString()),
	...
	public JSONObject queryId(String mid, Integer type, int isBase62)
			throws WeiboException {
		return client
				.get(weibo4j.util.WeiboConfig.getValue("baseURL") + "statuses/queryid.json",
	...
	public List<Emotion> getEmotions() throws WeiboException {
		return Emotion
				.constructEmotions(client.get(weibo4j.util.WeiboConfig.getValue("baseURL")
	...
	public JSONArray getStatusesCount(String ids) throws WeiboException {
		return client.get(
				weibo4j.util.WeiboConfig.getValue("baseURL") + "statuses/count.json",
