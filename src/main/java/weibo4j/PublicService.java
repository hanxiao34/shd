...
public class PublicService extends Weibo {
	...
	public JSONArray provinceList(String country) throws WeiboException {
		return client.get(
				weibo4j.util.WeiboConfig.getValue("baseURL") + "common/get_province.json",
	...
	public JSONArray provinceList(String country, String language)
			throws WeiboException {
		return client
				.get(weibo4j.util.WeiboConfig.getValue("baseURL")
	...
	public JSONArray cityList(String province) throws WeiboException {
		return client
				.get(weibo4j.util.WeiboConfig.getValue("baseURL") + "common/get_city.json",
	...
	public JSONArray cityListOfCapital(String province, String capital)
			throws WeiboException {
		return client.get(
				weibo4j.util.WeiboConfig.getValue("baseURL") + "common/get_city.json",
	...
	public JSONArray countryList() throws WeiboException {
		return client.get(
				weibo4j.util.WeiboConfig.getValue("baseURL") + "common/get_country.json",
				access_token).asJSONArray();
	}
	...
	public JSONObject getTomeZone() throws WeiboException {
		return client.get(
				weibo4j.util.WeiboConfig.getValue("baseURL") + "common/get_timezone.json",
