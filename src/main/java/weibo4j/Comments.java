...
public class Comments extends Weibo {
	...
	public CommentWapper getCommentById(String id) throws WeiboException {
		return Comment.constructWapperComments(client.get(
				weibo4j.util.WeiboConfig.getValue("baseURL") + "comments/show.json",
	...
	public CommentWapper getCommentById(Map<String, String> map)
		...
		return Comment.constructWapperComments(client.get(
				weibo4j.util.WeiboConfig.getValue("baseURL") + "comments/show.json", parList,
				access_token));
	}
	...
	public CommentWapper getCommentByMe() throws WeiboException {
		return Comment.constructWapperComments(client.get(
				weibo4j.util.WeiboConfig.getValue("baseURL") + "comments/by_me.json",
				access_token));
	}
	...
	public CommentWapper getCommentByMe(Map<String, String> map)
		...
		PostParameter[] parList = ArrayUtils.mapToArray(map);
		return Comment.constructWapperComments(client.get(
				weibo4j.util.WeiboConfig.getValue("baseURL") + "comments/by_me.json", parList,
				access_token));
	}
	...
	public CommentWapper getCommentToMe() throws WeiboException {
		return Comment.constructWapperComments(client.get(
				weibo4j.util.WeiboConfig.getValue("baseURL") + "comments/to_me.json",
				access_token));
	}
	...
	public CommentWapper getCommentToMe(Map<String, String> map)
		...
		PostParameter[] parList = ArrayUtils.mapToArray(map);
		return Comment.constructWapperComments(client.get(
				weibo4j.util.WeiboConfig.getValue("baseURL") + "comments/to_me.json", parList,
				access_token));
	}
	...
	public CommentWapper getCommentTimeline() throws WeiboException {
		return Comment.constructWapperComments(client.get(
				weibo4j.util.WeiboConfig.getValue("baseURL") + "comments/timeline.json",
				access_token));
	}
	...
	public CommentWapper getCommentTimeline(Map<String, String> map)
		...
		PostParameter[] parList = ArrayUtils.mapToArray(map);
		return Comment.constructWapperComments(client.get(
				weibo4j.util.WeiboConfig.getValue("baseURL") + "comments/timeline.json", parList,
				access_token));
	}
	...
	public CommentWapper getCommentMentions() throws WeiboException {
		return Comment.constructWapperComments(client.get(
				weibo4j.util.WeiboConfig.getValue("baseURL") + "comments/mentions.json",
				access_token));
	}
	...
	public CommentWapper getCommentMentions(Map<String, String> map)
		...
		PostParameter[] parList = ArrayUtils.mapToArray(map);
		return Comment.constructWapperComments(client.get(
				weibo4j.util.WeiboConfig.getValue("baseURL") + "comments/mentions.json", parList,
				access_token));
	}
	...
	public List<Comment> getCommentShowBatch(String cids) throws WeiboException {
		return Comment.constructComment(client.get(
				weibo4j.util.WeiboConfig.getValue("baseURL") + "comments/show_batch.json",
	...
	public Comment createComment(String comment, String id)
			throws WeiboException {
		return new Comment(client.post(weibo4j.util.WeiboConfig.getValue("baseURL")
	...
	public Comment replyComment(String cid, String id, String comment,
		...
		return new Comment(
				client.post(
						weibo4j.util.WeiboConfig.getValue("baseURL") + "comments/reply.json",
						new PostParameter[] {
								new PostParameter("comment", comment),
								new PostParameter("id", id),
